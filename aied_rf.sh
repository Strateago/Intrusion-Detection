...
# Model train
python3 $HOME/Intrusion-Detection/execute_model_train_validation.py --model_train_valid_config config_jsons/AIED/model_train/AVTP_RandomForest_train.json
...
# Metrics extraction
python3 $HOME/Intrusion-Detection/plot_metrics.py --path output/AIED/detection
