...
# # Model test
# python3 $HOME/automotive-ids-evaluation-framework/execute_model_test.py --model_test_config config_jsons/TOW/model_test/RF_test_config.json

# # Metrics extraction
# python3 $HOME/automotive-ids-evaluation-framework/plot_metrics.py --path output/TOW/RF
